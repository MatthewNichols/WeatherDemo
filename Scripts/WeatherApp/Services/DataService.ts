        ...
        getData(): any {
            return {
                ...
                days: [
                    ...
                    { dayIndex: 1, lowTemp: 53, highTemp: 54, windSpeed: 8, windDirection: "NW", basicCondition: "Sunny", humidity: 0.47, sunrise: 635, sunset: 1749, moonrise: 635, moonset: 1749, moonDesc: "Waning Crescent, 4% of the Moon is Illuminated" },
                    { dayIndex: 2, lowTemp: 55, highTemp: 56, windSpeed: 12, windDirection: "NW", basicCondition: "Rainy", humidity: 0.47, sunrise: 635, sunset: 1749, moonrise: 635, moonset: 1749, moonDesc: "Waning Crescent, 4% of the Moon is Illuminated" }
                ]
            };
        }
    }
